...
;(function ( $, window, undefined ) {
    ...
    function imodTabs(element, options) {
        ...
        this.tab3 = this.element.parentElement.parentElement.classList.contains('imod-tabs-3');
        this.$element = this.tab3 ? jQuery(this.element.parentElement.parentElement.parentElement).find(this.element) :  jQuery(this.element.parentElement.parentElement.parentElement.parentElement.parentElement).find(this.element); // Selected jQuery element
    ...
    imodTabs.prototype._loadElements = function() {
        ...
        var $ul = (_this.options.navigationContainer === '') ? this.$element.find('ul:first') : jQuery(this.$element.context).find('ul:first');
        var tabs = [];
        var id = 0;
        ...
        jQuery('li', $ul).each(function() {
            ...
            var $tab = jQuery(_this.$element.context).find(this);
            ...
            if(!isExcluded) {
                ...
                $panel = jQuery($anchor.context).find(panelSelector);
