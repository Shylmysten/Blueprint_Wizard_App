...
const VerticalTabsPattern = () => {
    const vTabsRef = useRef(null);
    const [isInitialized, setIsInitialized] = useState(false);
    
    useEffect(() => {
        const initializeTabs = () => {
            if (typeof window.$ !== 'undefined' && typeof window.$.fn.imodTabs !== 'undefined') {
                const tabs = vTabsRef.current;
    ...
    return ( 
        <section className="imod-tabs-2 sectionRow tabSection" data-sectionname="tabs-2">
            <div className="container">
                <div className="row">
                    <div className="col-xs-12 sectionHeader emptyCheck" id="ContentMiddleLayoutTabs2Hdr" runat="server">
                        <h2>Tabbed Content #2</h2>
                    </div>
                </div>
                <div className="row">
                    <div className="section-tabs">
                        <div ref={vTabsRef} className="tabs-wrap vertical">
                            <div className="menuwrap emptyCheck" id="ContentMiddleLayoutTabsNav2" runat="server">
                            ...
                            <div className="content">
                                ...
                                <div className="content-container" id="tab-panel-2">
                                    <div id="ContentMiddleLayout2Tab2" runat="server" className="emptyCheck">
                                            <h3>Tab Area #2</h3>
                                            <div className="snippetrow">
                                                    <div className="split30left">
                                                            <Image 
                                ...
                                <div className="content-container" id="tab-panel-3">
                                    ...
                                    <div id="ContentMiddleLayout2Tab3" runat="server" className="emptyCheck">
                                            <h3>Tab Area #3</h3>
                                ...
                                <div className="content-container" id="tab-panel-4">
                                    <div id="ContentMiddleLayout2Tab4" runat="server" className="emptyCheck">
                                            <h3>Tab Area #4</h3>
                                            <div className="snippetrow">
                                                    <div className="split30left">
                                                            <Image 
                                ...
                                <div className="content-container" id="tab-panel-5">
                                    <div id="ContentMiddleLayout2Tab5" runat="server" className="emptyCheck">
                                        <h3>Tab Area #5</h3>
...
export default VerticalTabsPattern;