...
const HorizantalTabsPattern = () => {
    const hTabsRef = useRef(null);
    const [isInitialized, setIsInitialized] = useState(false);

    useEffect(() => {
        const initializeTabs = () => {
            if (typeof window.$ !== 'undefined' && typeof window.$.fn.imodTabs !== 'undefined') {
                const tabs = hTabsRef.current;
    ...
    return ( 
            <section className="imod-tabs-1 sectionRow tabSection" data-sectionname="tabs-1">
                <div className="container">
                    <div className="row">
                        <div className="col-xs-12 sectionHeader emptyCheck" id="ContentMiddleLayoutTabs1Hdr" runat="server">
                            <h2>Tabbed Content #1</h2>
                        </div>
                    </div>
                    <div className="row">
                        <div className="section-tabs">
                            <div ref={hTabsRef} className="tabs-wrap horizontal">
                                <div className="menuwrap emptyCheck" id="ContentMiddleLayoutTabsNav1" runat="server">
                                ...
                                <div className="content">
                                    ...
                                    <div className="content-container" id="tab-panel-1">
                                        <div id="ContentMiddleLayout1Tab1" runat="server" className="emptyCheck">
                                                ...
                                                <div className="snippetrow">
                                                        ...
                                                        <div className="split70right">
                                                                <p>This is a happy place, little squirrels live here and play. These trees are so much fun. I get started on them and I have a hard time stopping. Let's make a nice big leafy tree. Just think about these things in your mind - then bring them into your world. With practice comes confidence.
                                                                    </p>
                                    ...
                                    <div className="content-container" id="tab-panel-2">
                                        <div id="ContentMiddleLayout1Tab2" runat="server" className="emptyCheck">
                                                <h3>Tab Area #2</h3>
                                                <div className="snippetrow">
                                                        <div className="split30left">
                                                                <Image 
                                                        ...
                                                        <div className="split70right">
                                                                <p>Working it up and down, back and forth. In nature, dead trees are just as normal as live trees. Trees grow in all kinds of ways. They're not all perfectly straight. Not every limb is perfect. Without washing the brush, I'm gonna go right into some Van Dyke Brown, some Burnt Umber, and a little bit of Sap Green.
                                                                    </p>
                                    ...
                                    <div className="content-container" id="tab-panel-3">
                                        ...
                                        <div id="ContentMiddleLayout1Tab3" runat="server" className="emptyCheck">
                                                <h3>Tab Area #3</h3>
                                            <p>Let's build some happy little clouds up here. I'm gonna add just a tiny little amount of Prussian Blue. It's hard to see things when you're too close. Take a step back and look.
                                            </p>
                                    ...
                                    <div className="content-container" id="tab-panel-4">
                                        <div id="ContentMiddleLayout1Tab4" runat="server" className="emptyCheck">
                                                <h3>Tab Area #4</h3>
                                                <div className="snippetrow">
                                                        <div className="split30left">
                                                                <Image 
                                    ...
                                    <div className="content-container" id="tab-panel-5">
                                        <div id="ContentMiddleLayout1Tab5" runat="server" className="emptyCheck">
                                            <h3>Tab Area #5</h3>
                                            ...
                                            <p>Maybe we got a few little happy bushes here, just covered with snow. You can get away with a lot. If you don't like it - change it. It's your world.
...
export default HorizantalTabsPattern;