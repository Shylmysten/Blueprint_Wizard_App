...
const Layout1Left = () => {
    ...
    return ( 
        <section className="contentRow interior-type1 sidebar-left" data-sectionname="interior-1">
                ...
                <div className="row">
                    <section className="col-sm-12 col-md-9 col-md-push-3 midWrap">
                        ...
                        <div id="ContentMiddle" runat="server">
                            ...
                            {/*<!-- Content Area -->*/}
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id justo eget orci sollicitudin
                                dapibus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                                <a href="#">Linked text example.</a> Phasellus quis bibendum nulla. Morbi venenatis urna eu
                                mauris aliquet faucibus. Nam eu ex lorem. Nam convallis, massa eu volutpat dapibus, mi sem porta
                                urna, id consequat ex velit vitae nisi. Fusce rutrum lectus vel tempus eleifend. Proin mi felis,
                                euismod sit amet magna in, sollicitudin feugiat felis.</p>
                            <p>Maecenas id turpis ante. Cras rhoncus iaculis dui, vel condimentum mi porttitor eget. Nam aliquet
                                massa sit amet velit condimentum, sit amet consequat justo tincidunt. Nam auctor tellus non
                                tellus vulputate volutpat. Cras convallis sem et scelerisque pulvinar. Morbi ac arcu et lacus
                                congue congue. Vestibulum venenatis porttitor libero, ac pretium nunc. Integer maximus vulputate
                                erat eu iaculis.</p>
                            ...
                            <div className="row">
                                <div className="col-xs-12 col-sm-6">
                                    <h2>Section Title</h2>
                                    <p>This content is created using the mobile-ready content blocks. Lorem ipsum dolor sit
                                        amet, consectetur adipiscing elit. Morbi id justo eget orci sollicitudin dapibus.
                                        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                                        Phasellus quis bibendum nulla. Morbi venenatis urna eu mauris aliquet faucibus. Nam eu
                                        ex lorem.</p>
                                </div>
                                <div className="col-xs-12 col-sm-6">
                                    <h2>Section Title</h2>
                    ...
                    <aside className="col-sm-12 col-md-3 col-md-pull-9 sideBar structLeft">
                        ...
                        <div id="ContentMiddleLayoutLeftBlock1" runat="server">
                            ...
                            <p>Curabitur cursus sodales massa congue vestibulum. Curabitur hendrerit ligula quis nunc dictum
                                volutpat. Aenean enim nulla, finibus id finibus nec, malesuada sed arcu.</p>
