...
const Layout2Left = () => {
    ...
    return ( 
        <section className="contentRow interior-type2 sidebar-left fullWidthImg" data-sectionname="interior-2">

            <div className="pageHero hidden-print">
                <section className="imageRotator">
                    <div className="fullImg" id="ContentMiddleLayoutFtImg" runat="server" style={{backgroundImage:"url(/interior-wide1.jpg)"}}>
                        <Image
                            border="0" 
                                ...
                                <section className="bp-preview-section interior-section col-xs-12" id="intSection3">
                                    ...
                                    <div className="accordion">
                                        <div className="panelCollapse collapseItem">
                                            ...
                                            <div className="panel-heading"><a aria-expanded="false" role="button" className="collapsed accordionToggle"
                                                    data-toggle="collapse" href="#panel1" data-parent="#undefined">
                                                    <span className="arrows">
                                                        <em className="fa fa-angle-down"></em>
                                                    </span>Lorem Ipsum Title Number One
                                                </a></div>
                                    
                                            <div role="tabpanel" className="panel-collapse collapse collapseItem" id="panel1">
                                                <div className="accordionPanelWrap panel-body">
                                                    <div className="preview">
                                                        <div className="thumb">
                                                            <img src="/interior-square2.jpg" alt="Football Quarterback Passing"/>
                                                        </div>
                                                        This example has no link. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras mi nunc,
                                                        porta nec ante nec, tincidunt
                                                        dapibus.
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="panelCollapse collapseItem">
                                            ...
                                            <div className="panel-heading"><a aria-expanded="false" role="button" className="collapsed accordionToggle"
                                                    data-toggle="collapse" href="#panel2" data-parent="#undefined">
                                                    <span className="arrows">
                                                        <em className="fa fa-angle-down"></em>
                                                    </span>Lorem Ipsum Title Number Two
                                                </a></div>
                                    
                                            <div role="tabpanel" className="panel-collapse collapse collapseItem" id="panel2">
                                                <div className="accordionPanelWrap panel-body">
                                                    <div className="preview">
                                                        <div className="thumb">
                                                            <a href="#">
                                                                <img src="/interior-square3.jpg" alt="Smiling Japanese Girl"/>
                                                            </a>
                                                        </div>
                                                        This example is linked. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras mi nunc, porta
                                                        nec ante nec, tincidunt
                                                        dapibus.
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="panelCollapse collapseItem">
                                            ...
                                            <div className="panel-heading"><a aria-expanded="false" role="button" className="collapsed accordionToggle"
                                                    data-toggle="collapse" href="#panel3" data-parent="#undefined">
                                                    <span className="arrows">
                                                        <em className="fa fa-angle-down"></em>
                                                    </span>Lorem Ipsum Title Number Three
                                                </a></div>
                                    
                                            <div role="tabpanel" className="panel-collapse collapse collapseItem" id="panel3">
                                                <div className="accordionPanelWrap panel-body">
                                                    <div className="preview">
                                    
                                                        This example has no thumbnail or link. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
                                                        mi nunc, porta nec ante nec, tincidunt
                                                        dapibus.
