...
const Layout2None = () => {
    ...
    return ( 
        <section className="contentRow interior-type2 no-sidebar fullWidthImg" data-sectionname="interior-2">
            ...
            <div className="container">
                ...
                <div className="row">
                    <section className="col-sm-12 col-md-10 col-md-push-1 midWrap">
