...
const Layout2Right = () => {
    ...
    return ( 
        <section className="contentRow interior-type2 sidebar-right fullWidthImg" data-sectionname="interior-2">
            ...
            <div className="container">
                ...
                <div className="row">
                    <section className="col-sm-12 col-md-9 midWrap">
