...
const CFBarRight = () => {
    ...
    return ( 
        <section className="contentRow interior-type1 sidebar-right crowdfunding-interior" data-sectionname="interior-crowdfunding">
            <div className="container">

                {/*<!-- Two Col Interior Verison -->*/}
                <div className="row">
                    <section className="col-xs-12 col-sm-8 midWrap">
  ...
  <p>Put light against light - you have nothing. Put dark against dark - you have nothing. It's the contrast of light and dark that each give the other one meaning. There are no mistakes. You can fix anything that happens. Remember how free clouds are. They just lay around in the sky all day long. I guess that would be considered a UFO. A big cotton ball in the sky. Just let this happen. We just let this flow right out of our minds. It's a super day, so why not make a beautiful sky?</p>
                            <h2>Header Two</h2>
                    ...
                    {/*<!-- SIDEBAR - RIGHT -->*/}
                    <aside className="col-xs-12 col-sm-4 sideBar structRight">
                        <div className="cpiProjectDetail" id="ContentMiddleLayoutStatsBox" runat="server">
                            <div className="imod-progWidget barsViz">
                                <div className="statsInner">
                                    <div className="data-viz">
                                        <div className="amt-percent">46%</div>
                                        <div className="vizWrapper">
                                            <div className="bar">
                                                <div className="progressBar" style={{height:"46%"}}></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="data-stats">
                                        <div className="widgetStat amt-goal">
                                            <span className="value">$30,870</span>
                                            <span className="label">Goal</span>
                                        </div>
                                        <div className="widgetStat amt-progress">
                                            <span className="value">$13,870</span>
                                            <span className="label">Raised</span>
                                        </div>
                                        <div className="widgetStat amt-donors">
                                            <span className="value">609</span>
                                            <span className="label">Donors</span>
                                        </div>
                                        <div className="widgetStat amt-time">
                                            <span className="value">110 Days</span>
