...
export default function DeviceViewSelector({ iframeClass, setDefaultClass, setTabletClass, setMobileClass }) {
  return (
    <div className="deviceWidths col-sm-12">
      <h5>Device Views</h5>
      <div className="col-xs-hidden col-sm-12 col-md-12">
        <div className={`col-sm-4 ${iframeClass === '' && 'activeView'}`}>
        ...
        <div className={`col-sm-4 ${iframeClass === 'tablet' && 'activeView'}`}>
        ...
        <div className={`col-sm-4 ${iframeClass === 'mobile' && 'activeView'}`}>
