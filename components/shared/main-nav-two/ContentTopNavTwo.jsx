...
const ContentTopNavTwo = ({ navItems, isDropDownToggleSwitchOn }) => {
  ...
  return (
    <nav id="ContentTopNavNow" className="desktopNavInner imodSiteMap hidden-xs hidden-sm" aria-label="Primary">
      <ul>
...
export default ContentTopNavTwo;