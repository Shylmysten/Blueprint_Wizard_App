...
const DrawerTwoComponent = ({ isDropdownToggleSwitchOn, isSocialMediaToggleSwitchOff }) => {
    ...
    //useEffect(() => {
    //    console.log('DrawerTwoComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in DrawerTwoComponent:', isDropdownToggleSwitchOn);
    ...
    return ( 
        <header className={`structHead imod-header-2 drawer ${isDropdownToggleSwitchOn ? 'dropdown' : ''}`} role="banner" id="top" data-sectionname="header-2">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-4 col-sm-8 col-md-9 headRight">
                            ...
                            <div className="row">
                                ...
                                <div className="desktopNav col-md-12 hidden-xs hidden-sm">
                                    <ContentTopNavTwo
            ...
            <div ref={mobileNavRef} className="desktopNav mobileNav col-md-12 hidden-md hidden-lg" aria-hidden={isMobileNavOpen ? 'false' : "true"} aria-expanded={isMobileNavOpen ? "false" : 'true'}>
...
export default DrawerTwoComponent;