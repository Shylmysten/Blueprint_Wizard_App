...
const DrawerOneComponent = ({ isDropdownToggleSwitchOn, isSocialMediaToggleSwitchOff }) => {
    ...
    //useEffect(() => {
    //    console.log('DrawerOneComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in DrawerOneComponent:', isDropdownToggleSwitchOn);
    //}, [isDropdownToggleSwitchOn]);
    //useEffect(() => {
    //    console.log('DrawerOneComponent re-rendered');
    //    console.log('isSocialMediaToggleSwitchOff in DrawerOneComponent:', isSocialMediaToggleSwitchOff);
    ...
    const handleMobileToggleClick = () => {
        var mobileNavWrap = jQuery('.drawer .desktopNav.mobileNav');
        var trappedNav = document.querySelector('.drawer .desktopNav.mobileNav');
        ...
        function trapKeyBoardMobileNav(e) {
            ...
            var nav = document.querySelector('.drawer .desktopNav.mobileNav');
        ...
        const handleKeyUp = (e) => {
            if (e.key === "Escape") {
                if (document.body.classList.contains("openDrawer")) {
                    jQuery('.drawer .desktopNav').slideUp();
        ...
        <header className={cx(
            ...
            <div className="mainHeaderWrap">
                <div className="container">
                    <div className="row">
                        <div className="col-xs-10 col-sm-4 col-md-5 headLogo" id="ContentLogo" runat="server">
                        ...
                        <div className="col-xs-4 col-sm-8 col-md-7 headRight">
                            <div className="row">
                                <nav id="ContentUtilityNavNow" runat="server" className="col-xs-12 utilityNav hidden-xs hidden-sm" aria-label="Utility">
                                    <ul>
            ...
            <div className="desktopNav hidden-xs hidden-sm">
                <div className="container">
                    <div className="row">
                        <ContentTopNavOne
            ...
            <div ref={mobileNavRef} className="desktopNav mobileNav hidden-md hidden-lg" aria-hidden={isMobileNavOpen ? 'false' : "true"} aria-expanded={isMobileNavOpen ? "false" : 'true'}>
                <div className="container">
                    <div className="row">
                        ...
                        <div className="row">
                            <nav id="ContentMobileNavNow" runat="server" className="desktopNavInner col-md-12 imodSiteMap mobile-nav-js" aria-label="Primary Mobile">
                                <ul>
                                    ...
                                    <li className={cx('has-subnav', { active: isAccordionOpen[3] })} aria-haspopup="true" style={{position: 'relative'}} data-accordion-id='3'>
                                        <a href="#" style={{marginRight: '60px'}}>Page Three</a>
                                            ...
                                            <ul style={{display: 'none'}}>
                                                ...
                                                <li className=""><a href="#">Sub Longer Link 5</a></li>
                                                <li className=""><a href="#">Page Link 6</a></li>
                                                <li className=""><a href="#">Sub Longer Link 7</a></li>
                                                <li className=""><a href="#">Another Link 8</a></li>
                                            </ul>
                                    </li>
                                    ...
                                    <li><a href="#">Page Seven</a></li>
                                    <li><a href="#">Page Eight</a></li>
                                </ul>;

                            </nav>
                            {/*If the client doesn't want to use membertools and wants the utility nav*/}
                            <nav className="mobileUtilityNavNow" id="ContentMobileUtilNavNow" runat="server" aria-label="Mobile Utility">
                                <ul>
                                    <li><a href="#">University Home</a></li>
...
export default DrawerOneComponent;