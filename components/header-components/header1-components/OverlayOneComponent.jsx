...
const OverlayOneComponent = ({ isDropdownToggleSwitchOn, isSocialMediaToggleSwitchOff }) => {
    ...
    //useEffect(() => {
    //    console.log('OverlayOneComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in OverlayOneComponent:', isDropdownToggleSwitchOn);
    ...
    return ( 
        <header className={`structHead imod-header-1 overlay ${isDropdownToggleSwitchOn ? 'dropdown' : ''}`} role="banner" id="top" data-sectioname="header-1">
            ...
            <div ref={mobileNavRef} className="desktopNav mob mobileNav hidden-md hidden-lg" aria-hidden={isMobileNavOpen ? 'false' : "true"} aria-expanded={isMobileNavOpen ? "false" : 'true'}>
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <nav className="mobileUtilityNavNow imodSiteMap" id="ContentMobileUtilNavNow" runat="server" aria-label="Mobile Utility">
                            <ul>
                                <li><a href="#">University Home</a></li>
...
export default OverlayOneComponent;