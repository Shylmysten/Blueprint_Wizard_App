...
const OverlayThreeComponent = ({ isDropdownToggleSwitchOn }) => {
    ...
    //useEffect(() => {
    //    console.log('OverlayThreeComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in OverlayThreeComponent:', isDropdownToggleSwitchOn);
    ...
    return ( 
        <header className={`structHead imod-header-3 overlay ${isDropdownToggleSwitchOn ? 'dropdown' : ''}`} role="banner" id="top" data-sectionname="header-3">
                        ...
                        <div className="col-xs-3 col-sm-6 col-md-9 headRight">
                            ...
                            <div className="row">
                                ...
                                <div className="desktopNav">
                                    ...
                                    />
                                    <div id="ContentSearchDesktop" runat="server" className="search-desktop hidden-xs hidden-sm">
...
export default OverlayThreeComponent;