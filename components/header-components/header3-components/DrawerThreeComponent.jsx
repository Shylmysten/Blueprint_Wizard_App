...
const DrawerThreeComponent = ({ isDropdownToggleSwitchOn }) => {
    ...
    //useEffect(() => {
    //    console.log('DrawerThreeComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in DrawerThreeComponent:', isDropdownToggleSwitchOn);
    ...
    return ( 
        ...
        >
            <div className="mainHeaderWrap">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-9 hidden-xs hidden-sm headRight">
                            <div className="row">
            ...
            <div ref={mobileNavRef} className="desktopNav mobileNav hidden-md hidden-lg" aria-hidden={isMobileNavOpen ? 'false' : "true"} aria-expanded={isMobileNavOpen ? "false" : 'true'}>
                    ...
                    <nav id="ContentMobileNavNow" runat="server" className="desktopNavInner imodSiteMap" aria-label="Primary Mobile">
                        <ul>
...
export default DrawerThreeComponent;