...
const OverlayFourComponent = ({ isDropdownToggleSwitchOn, isSocialMediaToggleSwitchOff }) => {
    ...
    //useEffect(() => {
    //    console.log('OverlayFourComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in OverlayFourComponent:', isDropdownToggleSwitchOn);
    ...
    return ( 
        <header className={`structHead imod-header-4 overlay ${isDropdownToggleSwitchOn ? 'dropdown' : ''}`} role="banner" id="top" data-sectionname="header-4">
            <div className="mainHeaderWrap">
                <div className="container">
                    <div className="row">
                        <div className="col-xs-8 col-sm-4 col-sm-push-4 col-md-4 col-md-push-4 headLogo" id="ContentLogo" runat="server">
                        ...
                        <div className="col-xs-4 col-sm-4 hidden-md hidden-lg toggleMenu">
            ...
            <div ref={mobileNavRef} className="desktopNav mob mobileNav hidden-md hidden-lg" aria-hidden={isMobileNavOpen ? 'false' : "true"} aria-expanded={isMobileNavOpen ? "false" : 'true'}>
                <div className="container">
                    ...
                    <div className="row">
                        <nav id="ContentTopNavNowMob" runat="server" className="desktopNavInner hidden-md hidden-lg col-md-12 imodSiteMap" aria-label="Primary Mobile">
                            <ul>
...
export default OverlayFourComponent;