...
const DrawerFourComponent = ({ isDropdownToggleSwitchOn, isSocialMediaToggleSwitchOff }) => {
    ...
    //useEffect(() => {
    //    console.log('DraweFourComponent re-rendered');
    //    console.log('isDropdownToggleSwitchOn in DrawerFourComponent:', isDropdownToggleSwitchOn);
    ...
    return ( 
        <header className={`structHead imod-header-4 drawer ${isDropdownToggleSwitchOn ? 'dropdown' : ''}`} role="banner" id="top" data-sectionname="header-4">
            ...
            <div ref={mobileNavRef} className="desktopNav mobileNav hidden-md hidden-lg" aria-hidden={isMobileNavOpen ? 'false' : "true"} aria-expanded={isMobileNavOpen ? "false" : 'true'}>
                <div className="container">
                    ...
                    <div className="row">
                        <nav id="ContentMobileNavNow" runat="server" className="desktopNavInner col-md-12 imodSiteMap" aria-label="Primary Mobile">
                            <ul>
                    ...
                    <div className="row">
                        <nav className="mobileUtilityNavNow col-xs-12" id="ContentMobileMTNavNow" runat="server" aria-label="Mobile Community">
                            <ul>
...
export default DrawerFourComponent;